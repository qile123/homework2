...
public class Exercises1 extends AppCompatActivity {
    ...
    private static final String TAG = "qile";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ca = (CustomApplication)getApplication(); // 获得CustomApplication对象
        ...
        ca.setValue(ca.getValue() + "\n\n" + "Log:" + "\n" + ON_CREATE);
        Log.d(TAG, "Lifecycle Event: " + ON_CREATE);
        lifecycleDisplay.append(ca.getValue() + "\n");
    }
